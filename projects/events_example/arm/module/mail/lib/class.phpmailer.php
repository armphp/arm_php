 ...
 */
  ...
  public function SmtpConnect() {
    ...
    $this->smtp->do_debug = $this->SMTPARMDebug;
  ...
  * @param string $langcode ARMSOInterface 639-1 2-character language code (e.g. Portuguese: "br")
